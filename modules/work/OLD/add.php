			...
			<div class="row container-fluid">
				<div class="col-md-6">
					...
					<div class="form-group row">
						...
						<div class="col-10">
							<input class="form-control" id="work_number_formal" name="work_number_formal" value="<?php echo $work->generateFormalWorkNumberId($year, $work->generateNewWorkNumberId($year)); ?>" REQUIRED READONLY>

					    	<input type="hidden" id="work_number" name="work_number" value="<?php echo $work->generateNewWorkNumberId($year); ?>" REQUIRED READONLY>
						</div>
					</div>
					<div class="form-group row">
				...
				<div class="col-md-6">
					...
					<div class="form-group row">
						<label for="work_s_decision" class="col-2 col-form-label">Setup P: </label>
						<div class="col-10">
