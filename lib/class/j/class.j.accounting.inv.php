 <?php
	...
	class j_WorkAccountingInv extends Db{
...
/***** TRANSACTIONAL METHODS *****/
	public function getEntry($id){
			if(!empty($id) && !is_null($id)){
				$query = "SELECT * FROM work_j_acct_inv WHERE work_j_acct_inv.work_j_acct_info_id = :id";
		...
		public function addEntry(){
			...
			try{
				$query = "INSERT INTO work_j_acct_inv (
							work_j_acct_inv_id,
							work_j_acct_info_id,
							work_j_acct_inv_amount,
							work_j_acct_inv_date,
							work_j_acct_inv_ispaid,
